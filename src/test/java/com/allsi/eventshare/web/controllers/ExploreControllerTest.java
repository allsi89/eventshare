...
public class ExploreControllerTest {
  ...
  @Test
  public void exploreOptionsGet_withNoLoggedUser_returnsLogin() throws Exception {
    mockMvc.perform(get("/explore/options"))
        .andExpect(redirectedUrl("http://localhost/users/login"));
  }

  @Test
  @WithMockUser
  public void exploreOptionsGet_withLoggedUser_returnsHome() throws Exception {
    mockMvc.perform(get("/explore/options"))
        .andExpect(view().name("explore/explore"));
  }
